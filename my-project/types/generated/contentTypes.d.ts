...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    singola_ricercas: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::singola-ricerca.singola-ricerca'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiNotificaNotifica extends Schema.CollectionType {
  ...
  attributes: {
    Notifica: Attribute.String;
    dataNotifica: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSingolaRicercaSingolaRicerca extends Schema.CollectionType {
  ...
  attributes: {
    dataRicerca: Attribute.DateTime;
    testoRicerca: Attribute.String;
    user: Attribute.Relation<
      'api::singola-ricerca.singola-ricerca',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    ricercaEffettuata: Attribute.Enumeration<
      [
        'ArticoliGDPR',
        'CWE',
        'ISO',
...
export interface ApiStrategyStrategy extends Schema.CollectionType {
  ...
  attributes: {
    nomeStrategia: Attribute.String;
    patterns: Attribute.Relation<
      'api::strategy.strategy',
      'manyToMany',
      'api::pattern.pattern'
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::singola-ricerca.singola-ricerca': ApiSingolaRicercaSingolaRicerca;
